...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center px-8 gap-8 duration-200">
      <h1 className="text-5xl xl:text-7xl xl:leading-loose leading-normal font-bold font-serif bg-gradient-to-r from-orange-700 via-blue-500 to-green-400 text-black hover:text-transparent cursor-default bg-clip-text bg-360% animate-gradient">
